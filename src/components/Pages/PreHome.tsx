...
export default function PreHome() {
  ...
  if (loading) {
    return (
      <div className="">
        ...
        <h1 className="flex items-center justify-center" >Загрузка может занять до 2 минут.</h1>
      </div>
  ...
  return (
    <div className=" mb-[70px]">
      ...
      <div className="max-w-[1100px] mx-auto xl:mt-[20px] mt-[100px]  bg-gray-200 dark:bg-gray-900 px-4  sm:px-8 py-10">
            ...
            {recs.length === 0 ? (
              ...
              recs.map((r) => {
                ...
                return (
                  ...
                  >
                    <div className="relative z-10 w-[215px] shadow-lg  h-[215px] rounded-full overflow-hidden">
                      <img
                        src={anime.thumbnail ?? "/placeholder.jpg"}
                        alt={anime.nameEn ?? anime.nameRu ?? "poster"}
                        className="w-full h-full object-cover bg-white/90 dark:bg-gray-800 shadow-lg scale-110 group-hover:scale-115 transition-transform duration-300"
                      />
                    </div>
                    ...
                    <div className="-mt-[120px] w-52 bg-white dark:bg-gray-800 pt-10 px-4 text-center transition-all duration-300 relative ">
                      ...
                      >
                        <button
                          ...
                          className="font-bold -mr-2 w-5 h-5 rounded-full -mb-[12px] bg-gray-950/25 dark:bg-gray-950/40 text-white flex items-center justify-center transition-transform"
                        >
                          i
                        </button>
