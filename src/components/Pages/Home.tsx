            ...
            >
              ...
              <div className="p-4 flex flex-col gap-2">
                ...
                <div className="flex justify-between items-center mt-2">
                  <span className="inline-flex items-center gap-1 text-yellow-400 font-semibold drop-shadow-sm">
                    <span className="text-lg">★</span> {anime.rating}
                  </span>
                  <span className="text-xs text-slate-500">{anime.date}</span>
                </div>
                <Link to={`/anime/${anime.slug}`}>Watch</Link>
